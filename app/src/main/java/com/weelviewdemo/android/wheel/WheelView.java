...
package com.weelviewdemo.android.wheel;
...
import com.weelviewdemo.android.R;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xff00ff,
			0xffffff, 0xfff11f };
	...
	public void setCurrentItem(int index, boolean animated) {
		...
		if(onScrollChangeListener!=null) {//利用接口回调来对滑动时的adapter操作
			onScrollChangeListener.srollChangeListener(viewAdapter, currentItem);
		}
	}
...
//		canvas.drawLine(0, center + offset, getWidth(), center + offset, paint);
	...
	SrollChange onScrollChangeListener;

	public void setScrollChangeListener(SrollChange l) {
		onScrollChangeListener=l;
	}

	public interface SrollChange{
		public void srollChangeListener(WheelViewAdapter wheelViewAdapter, int item);
	}
